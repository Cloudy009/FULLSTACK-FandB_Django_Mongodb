...
if DB_ENGINE and DB_NAME and DB_USERNAME:
    ...
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'FandBShop',     # Thay bằng tên database MongoDB
        'ENFORCE_SCHEMA': False,            # Tùy chọn: nên đặt False nếu bạn dùng dữ liệu linh hoạt
        'CLIENT': {
            'host': MONGO_URI,  # Hoặc thay bằng URI MongoDB cloud
        }
    }
}
...
SOCIAL_AUTH_PIPELINE = (
    ...
    # 'chatApp.pipeline.create_user_room', 
)
